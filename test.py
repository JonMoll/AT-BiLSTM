...
arguments = sys.argv
model_state = arguments[1]
path_model_state = './states_models/' + model_state
...
dataset_test.ShuffleData()

dataloader = data.DataLoader(dataset_test, batch_size)
...
model.load_state_dict(torch.load(path_model_state))
...
name_all_accuracy_f1 = 'test_accuracy_f1.txt'
